...
// Increase memory limit for long simulations (10+ years)
...
try {
    ...
    switch ($action) {
        case 'run_simulation':
            ...
            if (!$poolId) {
                sendError('Run not started - missing Pool selection', 400);
            }

            // Load pool data from pools table
            ...
            if (!$poolRow) {
                sendError('Run not started - selected Pool not found or inactive', 400);
            }
